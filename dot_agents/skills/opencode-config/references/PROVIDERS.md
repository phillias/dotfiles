...
in `references/DESIGN.md` §8 (provider concurrency profiles, plus
opencode-fallback design, axi-memory design, retry_on_errors handling
already covered elsewhere in DESIGN.md).
