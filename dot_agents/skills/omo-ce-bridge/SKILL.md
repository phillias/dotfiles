...
This skill defines the contract between the OmO orchestrator (Sisyphus) and the compound-engineering skill suite. Loaded automatically when the OmO orchestrator detects CE skills installed at `~/.agents/skills/ce-*`.
...
**Skills location:** `~/.agents/skills/{grill-with-docs,grilling,domain-modeling}/`
